...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          isdark ? const Color(0xff374353) : const Color(0xfffafbff),
      body: Padding(
                  ...
                  Expanded(
                    ...
                    children: [
                      ...
                      CupertinoSwitch(
                        ...
                        thumbColor:
                            isdark ? Colors.blue : const Color(0xff374353),
                        value: isdark,
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: [
              ...
              BoxShadow(
                  color: isdark
                      ? const Color(0xffb4bcb4).withOpacity(0.2)
        ...
        child: Text(
          ...
          style: TextStyle(
              fontWeight: FontWeight.bold,
              fontSize: 25,
              color: isdark ? Colors.white : Color(0xff0185f2)),
        ),
      ),
    );
  }
